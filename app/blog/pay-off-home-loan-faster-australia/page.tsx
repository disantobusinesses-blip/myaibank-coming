...
export default function PayOffHomeLoanFasterPage() {
  return (
    <article>
      ...
      <p className="mb-6 leading-relaxed" style={{ color: '#333' }}>
        Learn how to{" "}
        <Link href="/blog/how-to-save-money-fast-australia" className="underline" style={{ color: '#180D27' }}>save money fast with a real budget</Link>,{" "}
        <Link href="/blog/save-for-house-deposit-faster-australia" className="underline" style={{ color: '#180D27' }}>save for a house deposit faster</Link>, or explore{" "}
